...
//======================================================================
const textarea = document.querySelector('.column-contact__textarea');
const valueSpan = document.querySelector('.column-contact__value span');
...
plug.addEventListener("click", function (e) {
	...
	if (targetElem.classList.contains('column-block__title')) {
		_slideToggle(targetElem.nextElementSibling, 500);
...
$(window).scroll(function (event) {
	...
	$('.main-screen__image').css('transform', 'translate3d(0, ' + s + 'px, 0)');
});
